...
Philosopher.prototype.startNaive = function(count) {
	...
	tryingNaive = function(count) {
		if(count > 0) {
			...
			console.log("Philosopher " + id + " took right fork and starts eat");
			setTimeout(function () {
				console.log("Philosopher " + id + " end eating");
			    forks[f1].release();
			    forks[f2].release();
			    tryingNaive(count - 1);
			}, 100) // zakładamy, że jedzenie trwa 1 milisekundę
		    })})
		}
	};
	
	setTimeout(function () {tryingNaive(count)}, 1);
}
